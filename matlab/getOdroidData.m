function [filedata,legend] = getOdroidData(x,y,test,type,pi)
...
%                     filename = sprintf("/home/joseph/Dropbox/rpi_testbed/pis_0k_baremetal/pi"+num2str(k)+"/" + nginxpi(k,l) +"htop-i%dPI%d.txt",(k-1),i);
                    filename = sprintf("/home/lunet/eljb13/Dropbox/rpi_testbed/"+pi+"/"+type+"/"+test+"/pi"+num2str(k)+"/data/" + num2str(nginxPids(k,l)) +"htop-i%dPI%d.txt",(j-1),(i-1));
                    ...
                    if isfile(filename)
                        ...
                        filedata{count} = cell2table({0000,0,0.300000000000000,'0:00.00';0000,0,0.300000000000000,'0:00.00'});
                    end
