function [allTim,allCpuPointsFinal,maxTime,totMeanCpu] = timeAverageLUQuart(data,time,test,type,pi)
...
%     totUppeQua{idx} = upperQuart;
    ...
    %allTim{idx} = timArray;
    allCpuPointsFinal{idx} = allCpuPoints;
%     view(-29,27)
%     xlabel("iteration")
%     ylabel("cpu usage %")
%     zlabel("time (S)")
